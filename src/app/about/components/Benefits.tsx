...
export default function Benefits(){
    return(
        <section className="w-auto sm:w-full h-auto sm:h-[481px] bg-[#F9F9F9] p-[10px] sm:py-[52px] sm:px-[93px]" style={{ backgroundImage: "url('/images/Image (2).png')", backgroundSize: "cover" }}>
            <div className="w-auto sm:w-full h-[364px] bg-none flex flex-col px-5 sm:px-0 justify-center items-center gap-20">
